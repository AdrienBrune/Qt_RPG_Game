...
Equipment::Equipment(QString name, QPixmap image, int weight, int price):
...
Weapon::Weapon(QString name, QPixmap image, int damage, int speed, int weight, int price):
    Equipment(name, image, weight, price),
    mDamage(damage),
    mSpeed(speed)
{
...
Sword::Sword(QString name, QPixmap image, int damage, int speed, int weight, int price, QString info):
    Weapon(name, image, damage, speed, weight, price)
{
    setInformation(info);
    Item::setShape();
}
...
ArmorPiece::ArmorPiece(QString name, QPixmap image, int defense, qreal dodge, int weight, int price):
    Equipment(name, image, weight, price),
    mDefense(defense),
    mDodgingStat(dodge)
{
...
Helmet::Helmet(QString name, QPixmap image, int defense, qreal dodge, int weight, int price, QString info):
    ArmorPiece(name, image, defense, dodge, weight, price)
{
    setInformation(info);
    Item::setShape();
}
...
Breastplate::Breastplate(QString name, QPixmap image, int defense, qreal dodge, int weight, int price, QString info):
    ArmorPiece(name, image, defense, dodge, weight, price)
{
    setInformation(info);
    Item::setShape();
...
Gloves::Gloves(QString name, QPixmap image, int defense, qreal dodge, int weight, int price, QString info):
    ArmorPiece(name, image, defense, dodge, weight, price)
{
    setInformation(info);
    Item::setShape();
...
Pant::Pant(QString name, QPixmap image, int defense, qreal dodge, int weight, int price, QString info):
    ArmorPiece(name, image, defense, dodge, weight, price)
{
    setInformation(info);
    Item::setShape();
...
Footwears::Footwears(QString name, QPixmap image, int defense, qreal dodge, int weight, int price, QString info):
    ArmorPiece(name, image, defense, dodge, weight, price)
{
    setInformation(info);
    Item::setShape();
...
Amulet::Amulet(QString name, QPixmap image, int defense, qreal dodgingStat, int weight, int price, QString info):
    ArmorPiece (name, image, defense, dodgingStat, weight, price)
{
    setInformation(info);
    Item::setShape();
}
