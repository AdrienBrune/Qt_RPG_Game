...
void Village_Goblin::setPosition(QPointF pos)
{
    ...
    for(WatchTower * tower : mWatchTowers)
    {
        tower->setPos(this->pos().x() + qrand()%(static_cast<int>(boundingRect().width()-tower->boundingRect().width())), this->pos().y() + qrand()%static_cast<int>(boundingRect().height()-tower->boundingRect().height()));
    ...
    for(Hut * hut : mHuts)
    {
        hut->setPos(this->pos().x() + qrand()%(static_cast<int>(boundingRect().width()-hut->boundingRect().width())), this->pos().y() + qrand()%static_cast<int>(boundingRect().height()-hut->boundingRect().height()));
